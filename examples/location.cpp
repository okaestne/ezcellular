...
int main(int argc, char* argv[]) {
    ...
    // cell location
    auto location = modem->location();
    std::cout << "Current cell location: " << location << "\n";

    // observe cell location
    modem->observe_location([](Location loc) {
        std::cout << "Cell location update: " << loc << std::endl;
    });
